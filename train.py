...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov7-tiny-silu-en675-rfb.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/example.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.p5.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=100)
    parser.add_argument('--batch-size', type=int, default=16, help='total batch size for all GPUs')
    parser.add_argument('--img-size-train', nargs='+', type=int, default=[480, 640], help='train image height width')
    parser.add_argument('--img-size-test', nargs='+', type=int, default=[480, 640], help='test image height width')
